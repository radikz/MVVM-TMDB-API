package id.radikz.mvvm_movie.view;
...
import id.radikz.mvvm_movie.adapter.MovieAdapter;
import id.radikz.mvvm_movie.model.Movie;
import id.radikz.mvvm_movie.view_model.MovieViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Movie> articleArrayList = new ArrayList<>();
    MovieViewModel articleViewModel;
    ...
    private void initialization() {
        ...
        // adapter
        adapter = new MovieAdapter(MainActivity.this, articleArrayList);
        my_recycler_view.setAdapter(adapter);

        // View Model
        articleViewModel = ViewModelProviders.of(this).get(MovieViewModel.class);
    }
    ...
    private void getMovieArticles() {
        articleViewModel.getArticleResponseLiveData().observe(this, articleResponse -> {
            if (articleResponse != null) {
                ...
                List<Movie> articles = articleResponse.getItems();
